...
<body>
    ...
    <div class="dashboard-container">
        ...
        <nav class="sidebar">
            <ul>
                <li><a href="#news" onclick="showSection('news')" id="news-nav"><i class="fas fa-newspaper"></i>
                        News</a></li>
                <?php if ($visibility['Tools'] === 1): ?>
                <li><a href="#tools" onclick="showSection('tools')" id="tools-nav"><i class="fas fa-wrench"></i>
                        Tools</a></li>
                <?php endif; ?>
                <?php if ($visibility['Leads'] === 1): ?>
                <li><a href="#leads" onclick="showSection('leads')" id="leads-nav"><i class="fas fa-envelope"></i>
                        Leads</a></li>
                <?php endif; ?>
                <?php if ($visibility['Pages'] === 1): ?>
                <li><a href="#pages" onclick="showSection('pages')" id="pages-nav"><i class="fas fa-file-alt"></i>
                        Pages</a></li>
                <?php endif; ?>
                <?php if ($visibility['My Orders'] === 1): ?>
                <li><a href="#my-orders" onclick="showSection('my-orders')" id="my-orders-nav"><i
                            class="fas fa-box"></i> My Orders</a></li>
                <?php endif; ?>
                <?php if ($visibility['Credit Cards'] === 1): ?>
                <li><a href="#credit-cards" onclick="showSection('credit-cards')" id="credit-cards-nav"><i
                            class="far fa-credit-card"></i> Credit Cards</a></li>
                <?php endif; ?>
                <?php if ($visibility['Dumps'] === 1): ?>
                <li><a href="#dumps" onclick="showSection('dumps')" id="dumps-nav"><i class="far fa-credit-card"></i>
                        Dumps</a></li>
                <?php endif; ?>
                <?php if ($visibility['My Cards'] === 1): ?>
                <li><a href="#my-cards" onclick="showSection('my-cards')" id="my-cards-nav"><i
                            class="fas fa-id-card"></i> My Cards</a></li>
                <?php endif; ?>
                <?php if ($visibility['My Dumps'] === 1): ?>
                <li><a href="#my-dumps" onclick="showSection('my-dumps')" id="my-dumps-nav"><i
                            class="fas fa-id-card"></i> My Dumps</a></li>
                <?php endif; ?>
                <li><a href="#add-money" onclick="showSection('add-money')" id="add-money-nav"><i
                            class="fas fa-dollar-sign"></i> Add Money</a></li>
                <li><a href="#rules" onclick="showSection('rules')" id="rules-nav"><i class="fas fa-gavel"></i>
                        Rules</a></li>
                <li>
                ...
                <li><a href="#seller-stats" onclick="showSection('seller-stats')" id="seller-stats-nav"><i
        ...
        <div class="main-content">
            ...
            <div id="tools" class="section">
                ...
                <div class="tool-item">
                    ...
                    <a href="buy_tool.php?tool_id=<?php echo $file['id']; ?>&section=tools"
                        onclick="return confirm('Are you sure you want to buy this item?');"
                        style="background-color: #28a745; color: #fff; padding: 8px 12px; border: none; border-radius: 4px; text-decoration: none; cursor: pointer; margin-top: 10px; display: inline-block;">Buy</a>
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
            </div>
            ...
            <div id="leads" class="section">
                ...
                <div class="tool-item">
                    ...
                    <a href="buy_tool.php?tool_id=<?php echo $file['id']; ?>&section=leads"
                        onclick="return confirm('Are you sure you want to buy this item?');"
                        style="background-color: #28a745; color: #fff; padding: 8px 12px; border: none; border-radius: 4px; text-decoration: none; cursor: pointer;">Buy
                    </a>
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
            ...
            <div id="my-orders" class="section">
                ...
                <ul>
                    ...
                    <div class="tool-item">
                        ...
                        <a href="download_tool.php?tool_id=<?php echo $order['tool_id']; ?>"
...
?>
            ...
            <div id="support" class="section">
                ...
                <div class="ticket-form">
                    ...
                    <form method="POST" action="submit_ticket.php">
                        ...
                        <button type="submit" <?php echo $hasOpenTicket ? 'disabled' : ''; ?>
                            id="submit-ticket-btn">Submit Ticket</button>
                    </form>
                ...
                <div class="ticket-list">
                    ...
                    <div class="ticket-item">
                        ...
                        <div id="conversation-<?php echo htmlspecialchars($ticket['id']); ?>"
                            class="conversation-details" style="display: none;">
                        ...
                        ?>
                            <div class="<?php echo $messageClass; ?>">
                                <p class="message-tag"><strong><?php echo htmlspecialchars($senderName); ?>:</strong>
                                </p>
                            ...
                            <form method="POST" action="submit_reply.php" class="reply-section"
                                ...
                                <textarea name="message"
                                    id="reply-message-<?php echo htmlspecialchars($ticket['id']); ?>"
                                    placeholder="Reply..." rows="2" maxlength="500" required></textarea>
                                <small
                                    id="reply-char-count-<?php echo htmlspecialchars($ticket['id']); ?>">0/500</small>
                                <button type="submit"
                                    id="reply-btn-<?php echo htmlspecialchars($ticket['id']); ?>">Send</button>
                            </form>
                            <?php elseif ($userReplyCount >= 3): ?>
                            <p class="disabled-message">The conversation has been closed by the Admin. You may proceed
                                by opening a new ticket if further assistance is required.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endforeach; ?>
                    ...
                    <div class="credit-card-container">
                        <div class="credit-card-info">
                            ...
                            <div><span class="label">State:</span>
                                <?php echo htmlspecialchars($card['state'] ?: 'N/A'); ?></div>
                            <div><span class="label">City:</span>
                                <?php echo htmlspecialchars($card['city'] ?: 'N/A'); ?></div>
                            <div><span class="label">Zip:</span>
                                <?php echo htmlspecialchars(substr($card['zip'], 0, 3)) . '***'; ?></div>
                            <div><span class="label">Price:</span> $<?php echo htmlspecialchars($card['price']); ?>
                            </div>
                            <div>
            ...
            <div id="my-cards" class="section">
                ...
                <div id="card-<?php echo htmlspecialchars($card['id']); ?>" class="credit-card-item">
                    ...
                    <div class="info-field"><strong>Country:</strong> <?php echo htmlspecialchars($card['country']); ?>
                    </div>
                    <div class="info-field"><strong>Phone Number:</strong>
                        <?php echo htmlspecialchars($card['phone_number']); ?></div>
                    <div class="info-field"><strong>Date of Birth:</strong>
                        <?php echo htmlspecialchars($card['date_of_birth']); ?></div>
            ...
            <div id="my-dumps" class="section">
                ...
                <div id="dump-<?php echo htmlspecialchars($dump['id']); ?>" class="dump-item">
                    ...
                    <div class="info-field"><strong>Country:</strong> <?php echo htmlspecialchars($dump['country']); ?>
                    </div>
                    <button class="copy-button"
                        onclick="copyDumpInfo(<?php echo htmlspecialchars($dump['id']); ?>)">Copy</button>
                    <button class="check-dump-button"
                        onclick="checkDump(<?php echo htmlspecialchars($dump['id']); ?>)">Check</button>
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
