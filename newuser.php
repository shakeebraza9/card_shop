...
$unreadMessageClass = $unreadCount > 0 ? 'red-dot' : '';


// $creditCardCountries = $pdo->query("
//     SELECT DISTINCT 
//     UPPER(TRIM(REPLACE(REPLACE(REPLACE(country, CHAR(160), ''), CHAR(9), ''), CHAR(0xA0), ''))) AS country 
//     FROM credit_cards 
//     WHERE country IS NOT NULL AND country != '' 
//     GROUP BY UPPER(TRIM(REPLACE(REPLACE(REPLACE(country, CHAR(160), ''), CHAR(9), ''), CHAR(0xA0), '')))
